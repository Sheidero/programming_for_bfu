...
bool isSogl(char b1, char b2) {
    ...
    /*
    int sogl[21] = {193,194,195,196,198,199,201,202,203,204,205,207,208,209,210,212,213,214,215,216,217};
    
    for (int i = 0; i < 21; i++) {
        if (sogl[i] == (int)b1 || sogl[i] + 32 == (int)b1){
            flag1 = true;
        }
        if (sogl[i] == (int)b2 || sogl[i] + 32 == (int)b2){
            flag2 = true;
        }
    }
     */
